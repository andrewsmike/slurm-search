...
def multienv_atari_benchmark_vsarsa():
...
multienv_atari_benchmark_vsarsa_config = {
    "agent": "atari:vsarsa",
    ...
    "hp_space": {
        ...
        #"minibatch_size": scope.bounded(hp.qlognormal("update_frequency", log(32), log(32)/8, 1), minimum=4, maximum=64),
...
multienv_atari_benchmark_vsarsa_debug_overrides = {
    "search": {
        "method": "inline",
        "setting_samples": 3,
...
def display_multienv_atari_benchmark_vsarsa(session_name, params, results):
    display_setting_surface(
...
multienv_atari_benchmark_vsarsa_exp = {
    "config": multienv_atari_benchmark_vsarsa_config,
    "debug_overrides": multienv_atari_benchmark_vsarsa_debug_overrides,
    "display_func": display_multienv_atari_benchmark_vsarsa,
    "experiment_func": multienv_atari_benchmark_vsarsa,
}
